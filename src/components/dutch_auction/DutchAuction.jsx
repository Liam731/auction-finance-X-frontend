...
import OperationAuction from "./OperationAuction";
...
const DutchAuction = () => {
  ...
  return (
    <Section id="dutch auction" className="overflow-hidden">
      <div className="container md:pb-10 py-8">
        <Heading tag="Ready to go" title="Let's Start Dutch Auction" />
